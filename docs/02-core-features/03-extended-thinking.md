...
| **수동** (Manual) | Sonnet 4.5, Haiku 4.5 | budget_tokens를 명시적으로 지정 |
...
- Opus 4.6과 Sonnet 4.5는 **요약된** 사고를 보여줍니다 (전체가 아님)
- 토글로 켜고 끌 수 있습니다
...
| **Sonnet 4.5** | $15 / 1M 토큰 | 기본 | budget_tokens에 비례 |
...
| 특성 | Opus 4.6 | Sonnet 4.5 | Haiku 4.5 |
|------|:--------:|:----------:|:---------:|
