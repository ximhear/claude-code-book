...
> **기본 노력 수준**: Max/Team 구독자는 기본 노력 수준이 **medium**입니다. "ultrathink"를 프롬프트에 포함하면 다음 턴에 **high** effort가 활성화됩니다. 현재 노력 수준은 로고/스피너 옆에 시각적으로 표시됩니다 (○ low, ◐ medium, ● high). 이전의 "max" 수준은 제거되었으며, high가 최대 노력 수준입니다.
